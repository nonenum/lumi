...
class Lumi(Gtk.ApplicationWindow):
    def __init__(self, app):
        ...
        print("[LUMI]: Launching version", Globals.g_application_version, "--", Globals.g_code_name)
        ...
        self.texture_walk_right = Gdk.Texture.new_from_filename("res/walk_right.png")
        self.texture_walk_left = Gdk.Texture.new_from_filename("res/walk_left.png")
        self.texture_walk_right_accent = Gdk.Texture.new_from_filename("res/walk_right_accent.png")
        self.texture_walk_left_accent = Gdk.Texture.new_from_filename("res/walk_left_accent.png")
    ...
    def animate(self):
        ...
        if self.walk_direction == 1:
            if self.is_walking:
                if self.current_sprite == 1:
                    self.image.set_from_paintable(self.texture_walk_right_accent)
                if self.current_sprite == 2:
                    self.image.set_from_paintable(self.texture_walk_right)
            ...
            if self.is_walking:
                if self.current_sprite == 1:
                    self.image.set_from_paintable(self.texture_walk_left_accent)
                if self.current_sprite == 2:
                    self.image.set_from_paintable(self.texture_walk_left)
                if self.current_sprite == 3:
